...
- [ ] 1. Update Type Definitions for Multi-Workflow Model
...
- [ ] 4. Refactor Builder Data Model — Single Flow → Multiple Workflows
...
- [ ] 5. Multi-Workflow Canvas — Render and Edit Multiple Workflows Per State
...
- [ ] 6. Refactor Save Logic — Workflows → Triggers + AllowedActions + Fallback
...
- [ ] 7. Refactor Right Panel — Workflow + State Editing
...
- [ ] 8. Enhance Fallback Node with Error Type Selection
