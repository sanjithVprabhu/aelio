# environments/prod-ap-south-1 — production composition for ap-south-1 (Mumbai).
#
# Fully isolated APAC region (§12.1). Data residency: APAC tenant data stays in
# region. Replicates its own exports/recordings to a DR target per §12.5.
