# environments/prod-eu-west-1 — production composition for eu-west-1.
#
# Fully isolated EU region (§12.1). Data residency: EU tenant data stays in EU
# buckets/DB. Acts as the DR replication TARGET for us-east-1 exports/recordings,
# and replicates its own exports/recordings onward per the DR plan (§12.5).
